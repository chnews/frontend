        ...
        <div className='container-fluid'>
          ...
          <div className='row mt-3'>
            <div className='col-md-4 text-center'>
              ...
              <p className={styles.content_justify}>{last[0]?.excerpt}</p>
            </div>
            ...
            <div className='col-md-4 text-center'>
              ...
              <p className={styles.content_justify}>{last[1]?.excerpt}</p>
            </div>
            ...
            {/* <img src={`${API}/blog/photo/${last[2]?.slug}`} style={{ width: '100%' }} /> */}
              ...
              <p className={styles.content_justify}>{last[2]?.excerpt}</p>
            </div>
          </div>
...
{/****************************  america section start here **********************************************************/}
          ...
          <div className='row mt-3'>
            ...
            <div className='col-lg-3 col-6 text-center'>
              ...
              <p className={styles.content_justify}>{america[1]?.excerpt}</p>
            </div>
            ...
            <div className='col-lg-3 col-6 text-center'>
              ...
              <p className={styles.content_justify}>{america[2]?.excerpt}</p>
            </div>
            ...
            <div className='col-lg-3 col-6 text-center'>
              ...
              <p className={styles.content_justify}>{america[7]?.excerpt}</p>
            </div>
          </div>
          ...
          <div className='row'>
            ...
            <div className='col-md-3'>
              <div className={styles.specialsec}>
                ...
                <h4 className={styles.bottomleft}>
                  <Link href={`/blogs/${spacial[0]?.slug}`}>
                    <a> 
                      {spacial[0]?.title}
                    </a>
                  </Link>
            ...
            <div className='col-md-3'>
              <div className={styles.specialsec}>
                <img src='img1.jpg' className='w-100 h-100' />
                <h4 className={styles.bottomleft}>
                  <Link href={`/blogs/${spacial[1]?.slug}`}>
                    <a> 
                      {spacial[1]?.title}
                    </a>
                  </Link>
            ...
            <div className='col-md-3'>
              <div className={styles.specialsec}>
                <img src='img1.jpg' className='w-100 h-100' />
                <h4 className={styles.bottomleft}>
                  <Link href={`/blogs/${spacial[2]?.slug}`}>
                    <a> 
                      {spacial[2]?.title}
                    </a>
                  </Link>
            ...
            <div className='col-md-3'>
              <div className={styles.specialsec}>
                <img src='img1.jpg' className='w-100 h-100' />
                <h4 className={styles.bottomleft}>
                  <Link href={`/blogs/${spacial[3]?.slug}`}>
                    <a> 
                      {spacial[3]?.title}
                    </a>
                  </Link>
